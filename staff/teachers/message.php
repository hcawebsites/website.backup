            ...
            <div class="col-md-7">
                <div class="table">
                    ...
                    <div id="studentUser" style="display:block;">
                        ...
                        <table class="table" id="search" style="color: #5c5c5c; font-size: 13px; font-weight: 400;">
                            <thead>
                    ...
                    <table class="table" id="search1" style="color: #5c5c5c; font-size: 13px; font-weight: 400;">
                            <thead>
                                <th class="col-md-1"></th>
                                <th class="col-md-5"></th>
                                <th class="col-md-6"></th>
                    ...
                    <?php
                       $query_teacher = mysqli_query($con, "SELECT * FROM teacher_tb inner join schedule on teacher_tb.Emp_ID = schedule.Teacher_ID inner join grade on schedule.Class_ID = grade.ID WHERE Emp_ID != '$myID' Group by Teacher_ID");
                    ...
                    <table class="table" id="search2" style="color: #5c5c5c; font-size: 13px; font-weight: 400;">
                            <thead>
                                <th class="col-md-1"></th>
                                <th class="col-md-5"></th>
                                <th class="col-md-6"></th>
...
function showModal(my_index,conversation_id,friend_index,my_type){
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
    	...
    	xhttp.open("GET", "conversation_history_teacher.php?my_id=" + my_index + "&my_type="+my_type + "&conversation_id="+conversation_id + "&friend_id="+friend_index, true);												
            ...
            if(keyCode == 13){
                ...
                if(msg!== ' '){
                    ...
                    var xhttp1 = new XMLHttpRequest();//MSK-00149-Start Ajax  
                        ...
                        xhttp1.open("GET", "../../staff-model/add_message.php?conversation_id=" + conversation_id + "&my_index="+my_index  + "&msg="+msg + "&user_type="+my_type + "&do="+do1, true);												
                        xhttp1.send();
...
function msgRead(my_index,conversation_id,friend_index,my_type){
	...
	var xhttp = new XMLHttpRequest();//MSK-000127-Ajax Start  
    	...
    	xhttp.open("GET", "../../staff-model/confirm_msg_read.php?conversation_id=" + conversation_id + "&friend_index="+friend_index + "&do="+do1 , true);												
...
function addFriends(aFriend){
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
    	...
    	xhttp.open("GET", "../../staff-model/add_friends.php?my_type=" + my_type +"&my_index="+my_id +"&friend_access="+friend_access +"&user_id="+user_id + "&do="+do1, true);												
  		xhttp.send();//MSK-00149--End Ajax
...
function confirmFriends(cFriend){
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
    	...
    	xhttp.open("GET", "../../staff-model/confrim_friends.php?myID=" + my_id +"&user_id="+user_id +"&do="+do1, true);												
  		xhttp.send();//MSK-00149--End Ajax
