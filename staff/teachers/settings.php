      ...
      <h1><i class="fa fa-lock" aria-hidden="true">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Teacher's Account</a></li>
      </ol>
      <hr>
      <div class="title">
...
include_once('../../database/connection.php');
  ...
  $sql="SELECT * FROM teacher_tb inner join user on teacher_tb.Emp_ID = user.Username Where teacher_tb.Emp_ID = '$teacher_id'";
    ...
    <form method="POST" action="" enctype="multipart/form-data" id="change_form">
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="text" name="myID" value="<?php echo $teacher_id; ?>" class="form-control" readonly><br>
         ...
         $('#change').click(function(){
             ...
             if(old == "" || _new == "" || cpass == ""){
              ...
              'info'
                 ...
                 $.ajax({
                     url: "../../staff-model/teacher-settings.php",
                     type: "POST", 
