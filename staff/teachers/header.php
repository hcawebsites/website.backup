...
function confirmFriend(my_id,my_type,friend_index){
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
    	...
    	xhttp.open("GET", "../../staff-model/confrim_friends.php?myID=" + my_id +"&user_id="+friend_index +"&do="+do1, true);						
  		xhttp.send();
...
function deletefriend(my_id,my_type,friend_index){
  ...
  var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
      ...
      xhttp.open("GET", "../../staff-model/delete_friend_request.php?myID=" + my_id +"&user_id="+friend_index +"&do="+do1, true);                        
      xhttp.send();
