      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="add_student_record.php"><i class="fa fa-circle-o"></i>&nbspAdd New Record</a></li>
            <li><a href="student_record.php"><i class="fa fa-circle-o"></i>&nbspStudent Record</a></li>
            <li><a href="appointment.php"><i class="fa fa-circle-o"></i>&nbspAppointments</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <img src="../../assets/image/medicine.png" class="circle" style="margin-right: 2%;">
            <span>Medicine</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          ...
          <ul class="treeview-menu">
            <li><a href="medicine.php"><i class="fa fa-circle-o"></i>&nbspMedicine lists</a></li>
            <li><a href="add_new_medicine.php"><i class="fa fa-circle-o"></i>&nbspAdd New Medicine</a></li>
          </ul>
        </li>
