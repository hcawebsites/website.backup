      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="student-account.php"><i class="fa fa-circle-o"></i>&nbspStudent Account</a></li>
          </ul>
        </li>
        ...
        <li>
          <a href="add_new_fee.php">
            <img src="../../assets/image/cost.png" class="circle" style="margin-right: 2%;"></i> <span>Add Fees</span>
          </a>
        </li>
