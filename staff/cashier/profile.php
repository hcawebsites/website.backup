        ...
        <form action="" method="POST" enctype="multipart/form-data" id="my_profile">
            <div class="row">
                <div class="col-md-4 text-center"
                    ...
                    <img src="../../assets/upload/<?=$image?>" class="img-thumbnail" alt="Cinque Terre" style="width: 100px"><span><h4><?php echo $firstname ," ", $lastname;?></h4>

                    <img src="../../S-QRCODE/<?=$qr?>" class="img-thumbnail" alt="Cinque Terre" style="width: 100px; margin-bottom: 10px; margin-top: 50px;"><span><p style="color: #666666; font-weight: 500;"><?php echo $row['Emp_ID'];?></p></span>
				</div>
