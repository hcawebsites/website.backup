...
<?php 
        ...
        $classCode = mysqli_query($con, "SELECT Code FROM posts WHERE ID='$post_id'");
        ...
        if (isset($_POST['postComment' . $post_id])) {
			...
			$insert_post = mysqli_query($con, "INSERT INTO comments (Body, Code, Posted_Name, Image, Post_ID)VALUES ('$post_body','$code', '$name', '$picture', '$post_id')");
