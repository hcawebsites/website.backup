...
<?php include_once('../model/update_profile.php');?>
        ...
        <form action="" method="POST" enctype="multipart/form-data" id="my_profile">
            <div class="row">
                <div class="col-md-4 text-center"
                    ...
                    <p style="margin-top:-5px;"><b><?php echo $row['Admin_ID'];?></b></p></span>
				</div>
                ...
                <div class="col-md-8"
					...
					style="font-size:40px; cursor: pointer;">
						<a href="#" onclick="editProfile('<?php echo $myID; ?>')"><i class="fa fa-edit"></i></a>
					</div>
...
function editProfile(admin_id){
  ...
  var xhttp = new XMLHttpRequest(); 
    xhttp.onreadystatechange = function() {   
      ...
      xhttp.open("GET", "edit_admin.php?admin_id=" + admin_id , true);                       
      xhttp.send();
