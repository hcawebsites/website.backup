...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Junior High Department</a></li>
    	</ol>
	</section>
    <hr>
    <section class="content">
        <div class="table-master">
			<div class="table-title">
                <h3><i class="fa fa-graduation-cap" aria-hidden="true"><b> Junior High Department</b></i></h3>
                ...
                <div class="btn-master">
                    ...
                    <form class="form-inline" action="../reports/student_reports.php" method="POST" id="filter">
					    <div class="row">
                            <?php
                            $sql = "SELECT * FROM grade Where Department = 'JHSDEPT'";
           ...
           <div class="form-population">
            ...
            <table class="table table-bordered" id="search" style="color: #5c5c5c; font-size: 13px; font-weight: 400">
                ...
                <tbody id="data">
                    <?php 
                    $sql = "SELECT * from student inner join student_grade on student.Student_ID = student_grade.Student_ID inner join 
                    grade on student_grade.Class_ID = grade.ID WHERE grade.Department = 'JHSDEPT' AND student.Enrollment_Status = 'Enrolled'";
                    $result = mysqli_query($con, $sql);
