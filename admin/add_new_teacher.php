...
$teacher_id = "T-".(sprintf("%'.05d",rand(111,999)));
...
<div class="content-wrapper">
    ...
    <hr>
    <div class="table">
        <form action="" id="teacher-form" method="POST" enctype="multipart/form-data">
        <input type="hidden" class="form-control" name="myID" id="myID" value="<?=$myID?>" readonly>
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="teacher_id" id="teacher_id" value="<?=$teacher_id?>" readonly>
                </div>
                ...
                <div class="form-group col-md-3">
                   <button type="submit" name="btn_add" id="btn_add" class="form-control btn btn-success">Save</button>
           		</div>
