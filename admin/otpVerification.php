<?php  include_once ('../model/two-factor-authentication.php');  ?>

<?php 
$admin_id=$_SESSION["username"];
$sql = "SELECT * FROM user Where Username = '$admin_id'";
...
<body>
    ...
    <div class="resendCode">
           <p>Didn't receive CODE? <a href="resendCode.php" id="btn">Resend Code</a></p>
    </div>
</body>
...
<script>
    ...
    var myTimer = setInterval(() => {
        ...
        if (timer == -1) {
            ...
            document.getElementById('btn').href = 'resendCode.php';
