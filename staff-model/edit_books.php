...
if ($_POST) {
	...
	mysqli_query($con, "UPDATE books set ISBN = '$code', Title = '$title', Subtitle = '$subtitle', Author = '$author', Sub_Author = '$sub_author', Category = '$category', Total = '$total', Call_Number = '$callnumber' Where ID = '$id'");
